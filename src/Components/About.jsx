      ...
      <div className="flex flex-col md:flex-row justify-between items-center p-8">
        <div className="md:w-1/2 mb-8 md:mb-0">
          <div className="relative">
            ...
            <img
              className="absolute top-0 left-0 right-0 bottom-0 mx-auto rounded-full w-60 h-60 object-cover drop-shadow-2xl shadow-2xl  shadow-violet-100	  transparent bg-clip-content"
        ...
        <div className="md:w-1/2 flex flex-col md:items-start">
          ...
          <p className="italic mb-4 text-center md:text-left">
